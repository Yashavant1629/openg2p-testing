...
public class DBTPaymentManagerTest extends BaseLogin {

    @Test(dataProviderClass = ReadXLSData.class,dataProvider = "openg2pdata")
    public static void dbtPaymentManagerCreation(String managerName, String programName, String paymentEndpointURL, String idType) throws IOException, InterruptedException {
        login();
        ...
        commons.click(driver,By.xpath(locators.getProperty("dbt_manager_save_button")));
        commons.click(driver,By.xpath(locators.getProperty("bdt_manager_list_view")));
    ...
    @Test
    public static void dbtPaymentManagerMapping(String programName,String managerName) throws IOException, InterruptedException {
        login();
        commons.click(driver, By.xpath(locators.getProperty("menu_option")));
        commons.click(driver, By.xpath(locators.getProperty("programs")));
        String tableXPath = "";
